...
## Snapshot
- Systems-focused engineer (C++ / Go / Java / distributed systems)
- Built high-concurrency servers (50k+ req/sec) & custom network protocols
- Built a distributed payment ledger with Saga orchestration, idempotency, reconciliation, and chaos-tested failure recovery
- Worked on AI infra, agent systems, and edge-optimized pipelines
...
- Backend & Distributed Systems
  - Ledger Core → distributed payment system implementing Saga orchestration, idempotency, reconciliation, and chaos-tested failure recovery
